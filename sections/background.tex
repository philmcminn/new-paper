...
% Always reference sections like this, i.e. with a capital letter on "Section",
% followed by a non-breaking space (the ~ character), which keeps the word
% "Section" and the following number on teh same line.
